<%@ Page Language="VB" MasterPageFile="~/supplier.master" AutoEventWireup="false" CodeFile="~/modifyproduct.aspx.vb" Inherits="indiandeals.modifyproduct" title="Untitled Page" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 100%; height: 204px;">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="sls" Text="Product Modify" runat="server" Font-Bold="True" 
        ...
        <td colspan="4" align="center" valign="middle">
                <asp:Button ID="cmdmodify" Text="Modify Product" runat="server" /></td>
            </tr>
    </table>
</asp:Content>
